...
def calculateHeading(
    ...
    mag_data,
    time,
    gnss_initial_heading,
    initialPosition,
    gnssFreq=SENSOR_FREQ,
    P=None,
):
    ...
    # initialOritentation = quaternion_from_euler(
    #     0, 0, math.radians(gnss_initial_heading)
    # )
    # quats = orientationEKF2(
    #     accel=accel_data, gyro=gyro_data, time=time, q0=initialOritentation
    # )
